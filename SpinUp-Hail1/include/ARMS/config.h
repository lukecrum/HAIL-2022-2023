...
// Ticks per inch
#define TPI 9      			  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 9          // Ticks per inch for the middle wheel
...
#define ENCODER_PORTS 2, 4, 0                // Port 0 for disabled, // first port of left, right, middle encoders
...
#define LEAD_PCT .8		 // Go-to-pose lead distance ratio (0-1)
